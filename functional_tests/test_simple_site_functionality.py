...
class LoginAndBasicFunctionality(FunctionalTest):
    def test_admin_can_create_and_browse(self):
        ...
        self.assertEqual(inputbox.get_attribute("placeholder"), "Serial Number")
        ...
        self.assertEqual(secretbox.get_attribute("placeholder"), "Secret")
        ...
        self.assertEqual(requestbox.get_attribute("placeholder"), "Reason for request")
    ...
    def test_standard_user_can_request_and_admin_can_approve(self):
        ...
        disabled_button = self.browser.find_element_by_css_selector(
            "button.btn.btn-disabled.btn-info"
        ).text
