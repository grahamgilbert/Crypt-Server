...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('server_request', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('computer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Computer'])),
            ('requesting_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requesting_user', to=orm['auth.User'])),
            ('auth_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='auth_user', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('server', ['Request'])


    def backwards(self, orm):
        # Deleting model 'Request'
        db.delete_table('server_request')
