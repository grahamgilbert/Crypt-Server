...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Request.reason'
        db.delete_column('server_request', 'reason')

        # Adding field 'Request.approved'
        db.add_column('server_request', 'approved',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Request.reason_for_request'
        db.add_column('server_request', 'reason_for_request',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Request.reason_for_approval'
        db.add_column('server_request', 'reason_for_approval',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Request.reason'
        db.add_column('server_request', 'reason',
                      self.gf('django.db.models.fields.TextField')(default='None'),
                      keep_default=False)

        # Deleting field 'Request.approved'
        db.delete_column('server_request', 'approved')

        # Deleting field 'Request.reason_for_request'
        db.delete_column('server_request', 'reason_for_request')

        # Deleting field 'Request.reason_for_approval'
        db.delete_column('server_request', 'reason_for_approval')
